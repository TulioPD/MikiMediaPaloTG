...
public class CardDatabase : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        //Cards.Add(new Card(10, "Probablemente Dios", 9, 5, 10, "No sé que hará, pero espero que esté jodidamente rota de cojones", CardType.Criatura, "b7", "npi", "m1"));
        ...
        //Cards.Add(new Card(12, "Comunismo", 1, 1, 1, "Niega efectos adversos si hay cartas de con el nombre Ruso en tu campo", CardType.Hechizo, "b4", "Comunismo", "m5"));
        //Cards.Add(new Card(13, "Choraza", 1, 1, 1, "Si tienes una tierra Santiago en el campo, suma un punto de maná", CardType.Encantamiento, "b6", "Choraza", "m4"));
        //Cards.Add(new Card(14, "Santiago", 1, 1, 1, "Está muy lejos a pié", CardType.Tierra, "b1", "Santiago", "m2"));
        //Cards.Add(new Card(15, "Tripis", 1, 1, 1, "Voltea una de las cartas en el campo de tu adversario", CardType.Hechizo, "b3", "Tripis", "m3"));
        //Cards.Add(new Card(16, "One Piece 2", 1, 1, 1, "Si un monstruo de tipo Micky Media, añade dos toquens al campo sin coste alguno", CardType.Hechizo, "b5", "OP2", "m1"));
